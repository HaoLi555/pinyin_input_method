...
def build_frequency_table(corpus_name, save_path, trigarm):
    ...
    frequency_table=process_corpus(corpus_list=corpus_list,keys=keys,trigram=trigarm)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sina_path",default=SINA_NEWS_GBK,help="The sina_news_gbk corpus path.")
    parser.add_argument("--wiki_path",default=WIKI,help="The wiki_zh_2019 corpus path.")
    ...
    build_frequency_table(
        corpus_name=corpus_name, save_path=save_path, trigarm=trigram
    )
